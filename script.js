...
const products = [
  ...
  {
    name: "4x4 Closure Bounce - 99J Color",
...
📞 *Phone:* ${phone}
    ...
    fetch(`https://api.telegram.org/bot8036297818:AAFcg7_Akiv83HK7JcolJul7-8Qq2n2JrhY/sendMessage`, {
      ...
      body: JSON.stringify({ chat_id: "6945455531", text: message, parse_mode: "Markdown" })
    }).then(() => {
      alert("Order sent! Your Order ID is " + orderId);
